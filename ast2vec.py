...
def traces_plot(start, target, traces, X,roll_list, trees = None, plot_code = 0):
    ...
    # colormap = cm.magma
    #colorm = [cm.hsv(i * 1.0 /50, 1) for i in range(50)]
    plt.plasma()
    ...
    print("Shape of xarr:",Xarr.shape)
    #plt.legend(q, [str(r) for r in roll_list])
    if plot_code > 0:
